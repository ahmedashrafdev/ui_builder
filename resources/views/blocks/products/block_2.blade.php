        ...
        <div class="row">
                ...
                <div class="thumbnail no-border no-padding thumbnail-banner size-3x3">
                    <div class="media">
                        <a class="media-link" href="#">
                            <div class="img-bg" style="background-image: url({{asset('storage/assets/img/preview/shop/banner-3.jpg')}})"></div>
                            <div class="caption">
            ...
            <div class="col-md-6">
                <div class="thumbnail no-border no-padding thumbnail-banner size-2x3">
                    <div class="media">
                        <a class="media-link" href="#">
                            <div class="img-bg" style="background-image: url({{asset('storage/assets/img/preview/shop/banner-4.jpg')}})"></div>
                ...
                <div class="thumbnail no-border no-padding thumbnail-banner size-2x3">
                    <div class="media">
                        <a class="media-link" href="#">
                            <div class="img-bg" style="background-image: url({{asset('storage/assets/img/preview/shop/banner-5.jpg')}})"></div>
                            <div class="caption">
                                <div class="caption-wrapper div-table">
                                    <div class="caption-inner div-cell">
                                        <h2 class="caption-title"><span>Lorem Ipsum</span></h2>
