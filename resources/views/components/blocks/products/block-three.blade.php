        ...
        <div class="row">
                ...
                <div class="thumbnail no-border no-padding thumbnail-banner size-1x3">
                    <div class="media">
                        <a class="media-link" href="#">
                            <div class="img-bg" style="background-image: url({{asset('storage/assets/img/preview/shop/banner-1.jpg')}})"></div>
                            <div class="caption">
            ...
            <div class="col-md-3">
                <div class="thumbnail no-border no-padding thumbnail-banner size-1x1">
                    <div class="media">
                        <a class="media-link" href="#">
                            <div class="img-bg" style="background-image: url({{asset('storage/assets/img/preview/shop/banner-6.jpg')}})"></div>
            ...
            <div class="col-md-3">
                <div class="thumbnail no-border no-padding thumbnail-banner size-1x1">
                    <div class="media">
                        <a class="media-link" href="#">
                            <div class="img-bg" style="background-image: url({{asset('storage/assets/img/preview/shop/banner-7.jpg')}})"></div>
                            <div class="caption text-center">
                                <div class="caption-wrapper div-table">
                                    <div class="caption-inner div-cell">
                                        <h2 class="caption-title"><span>Lorem Ipsum</span></h2>
