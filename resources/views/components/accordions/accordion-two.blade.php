<div class="panel-group payments-options" id="accordion" role="tablist" aria-multiselectable="true">
        ...
        <div class="panel-heading" role="tab" id="headingThree">
            <h4 class="panel-title">
                ...
                <span class="overflowed pull-right">
                    <img src="{{asset('storage/assets/img/preview/payments/mastercard-2.jpg')}}" alt=""/>
                    <img src="{{asset('storage/assets/img/preview/payments/visa-2.jpg')}}" alt=""/>
                    <img src="{{asset('storage/assets/img/preview/payments/american-express-2.jpg')}}" alt=""/>
                    <img src="{{asset('storage/assets/img/preview/payments/discovery-2.jpg')}}" alt=""/>
                    <img src="{{asset('storage/assets/img/preview/payments/eheck-2.jpg')}}" alt=""/>
                </span>
            </h4>
        </div>
    ...
    <div class="panel panel-default">
        <div class="panel-heading" role="tab" id="heading4">
            ...
            <span class="overflowed pull-right"><img src="{{asset('storage/assets/img/preview/payments/paypal-2.jpg')}}" alt=""/></span>
            </h4>
        </div>
